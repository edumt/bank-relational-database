...
sql_create_tables_dictionary = {
    # Servico
    "create_servico_table": """CREATE TABLE IF NOT EXISTS servico 
    ...
    "create_cartao_table": """CREATE TABLE IF NOT EXISTS cartao
    ...
    "create_aplicacao_table": """CREATE TABLE IF NOT EXISTS aplicacao
        ...
        data_retirada text,
        FOREIGN KEY(id_tipo) REFERENCES tipo_servico(id_tipo) ON DELETE RESTRICT);""",
    "create_seguro_table": """CREATE TABLE IF NOT EXISTS seguro
        (id_seguro integer PRIMARY KEY AUTOINCREMENT,
        id_tipo integer NOT NULL,
        carencia integer,
        FOREIGN KEY(id_tipo) REFERENCES tipo_servico(id_tipo) ON DELETE RESTRICT);""",
    "create_tipo_servico_table": """CREATE TABLE IF NOT EXISTS tipo_servico
        (id_tipo integer PRIMARY KEY AUTOINCREMENT,
        nome text NOT NULL);""",
    # Conta
    "create_conta_table": """CREATE TABLE IF NOT EXISTS conta
    ...
    "create_telefone_table": """CREATE TABLE IF NOT EXISTS telefone
        (CPF text,
        CNPJ text,
        num_agencia integer,
    ...
    "create_transfere_para_table": """CREATE TABLE IF NOT EXISTS transfere_para
    ...
    # Agencia
    "create_agencia_table": """CREATE TABLE IF NOT EXISTS agencia
        (num_agencia integer PRIMARY KEY,
        CEP integer NOT NULL,
        rua text,
        num_endereco integer);""",
    # Funcionario
    "create_funcionario_table": """CREATE TABLE IF NOT EXISTS funcionario
